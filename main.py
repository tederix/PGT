...
page = st.selectbox("Выберите страницу", ["Задание 1", "Выполнил"])
...
if page == "Задание 1":
    ...
    page_1 = st.selectbox("Выберите необходимый график", ["Зависимость КПД от Pпп", "h - s диаграмма"])

    if page_1 == "Зависимость КПД от Pпп":
